...
python3 experiments-sbm.py --lr=[0.1,0.05,0.01] --epochs=5 --trials=2 --gpu=0 --threads=4 
"""
...
#                        help='Number of classes')
    ...
    vi = VI_SBM(num_nodes=args.N, num_classes=num_classes, 
                       priors={'theta_p':None, 
                         'B_p':None},
